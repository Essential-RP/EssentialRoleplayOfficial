local Translations = {
    error = {
        canceled = 'You sure you dont need help?',
    ...
    info = {
        ...
        respawn_revive = 'HOLD [~b~E~s~] FOR %{holdtime} SECONDS TO RESPAWN FOR $~db~%{cost}~s~',
        bleed_out = 'YOU WILL BLEED OUT IN: ~db~%{time}~s~ SECONDS',
        bleed_out_help = 'YOU WILL BLEED OUT IN: ~r~%{time}~s~ SECONDS, YOU CAN BE HELPED',
        request_help = 'PRESS [~db~G~s~] TO REQUEST HELP',
