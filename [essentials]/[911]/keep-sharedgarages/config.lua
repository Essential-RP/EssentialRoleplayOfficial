...
Config.VehicleWhiteList = {
     ['defaultPolice'] = {
          { label = 'PoliceVic', model = 'polvictoria' },
          { label = 'PoliceExp', model = 'polexplorer' },
     },
     ['heliPolice'] = {
...
Config.Garages = {
     ...
     ['mrpd'] = {
          ...
          zones = {
               vector2(434.49594116211, -984.66693115234),
               vector2(441.55554199219, -984.28680419922),
               vector2(448.12319946289, -983.91510009766),
               vector2(448.1994934082, -988.63159179688),
               vector2(448.45837402344, -993.3876953125),
               vector2(448.54541015625, -997.95166015625),
               vector2(448.5283203125, -998.5517578125),
               vector2(435.69451904297, -998.57135009766),
               vector2(435.09426879883, -998.650390625)
          },
          minz = 24.66,
          maxz = 28.66,
     ...
     ['troopers'] = {
          label = 'Troopers(Garage)',
          type = 'job',
          job = { 'sast' },
          onDuty = false,
          spawnPoint = {
               vec4(425.62646484375, -997.1044921875, 25.332220077515, 270.11584472656),
               vec4(425.73394775391, -994.4013671875, 25.332538604736, 270.08486938477),
               vec4(425.5837097168, -989.00213623047, 25.331663131714, 270.5061340332),
               vec4(425.89318847656, -984.18231201172, 25.332036972046, 269.28387451172),
               vec4(425.63247680664, -978.86010742188, 25.332525253296, 271.20303344727),
          },
          zones = {
               vector2(427.92138671875, -1000.0252685547),
               vector2(428.05786132813, -996.24664306641),
               vector2(428.27697753906, -989.35565185547),
               vector2(428.58450317383, -981.84735107422),
               vector2(428.33386230469, -977.45520019531),
               vector2(428.27062988281, -974.49627685547),
               vector2(423.15713500977, -974.77081298828),
               vector2(423.15835571289, -1000.2532348633)
          },
          minZ = 25.699974060059,
          maxZ = 25.700277328491,
          WhiteList = Config.VehicleWhiteList['defaultPolice'],
          garage_management = {
               -- access to garage management
               ['UOM26203'] = true,
