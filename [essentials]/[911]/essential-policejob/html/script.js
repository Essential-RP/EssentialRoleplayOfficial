...
Databank.Close = function() {
    ...
    $.post("https://essential-policejob/closeDatabank", JSON.stringify({}));
}
...
Fingerprint.Close = function() {
    ...
    $.post('https://essential-policejob/closeFingerprint');

}

Fingerprint.Update = function(data) {
    $(".fingerprint-id").html("Fingerprint Info<p>"+data.Name+"</b></p><p></b></p><p><br><b>"+data.Fingerprint+"</b></p></div>");
}

$(document).on('click', '.take-fingerprint', function(){
    $.post('https://essential-policejob/doFingerScan');
})
