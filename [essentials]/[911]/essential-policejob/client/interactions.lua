...
local function SearchPlayerJoe(player)
    PlayerSearched = player
    local ped = PlayerPedId()
    FreezeEntityPosition(PlayerPedId(), true)
    RequestAnimDict("anim@heists@load_box")
    Wait(100)
    TaskPlayAnim(ped, "anim@heists@box_carry@", "idle", 3.0, 3.0, -1, 48, 0, 0, 0, 0)
    Wait(600)
    ...
    Wait(100)
    TaskPlayAnim(ped, "missfam5_yoga", "start_pose", 3.0, 3.0, -1, 48, 0, 0, 0, 0)
    Wait(500)
    -- #Right leg
    loadAnimDict("missbigscore2aig_7@driver")
    Wait(100)
    TaskPlayAnim(ped, "missbigscore2aig_7@driver", "boot_r_loop", 3.0, 3.0, -1, 48, 0, 0, 0, 0)
    Wait(500)
    TriggerEvent('animations:client:EmoteCommandStart', {"medic2"})
    Wait(1000)
    loadAnimDict("missbigscore2aig_7@driver")
    Wait(100)
    TaskPlayAnim(ped, "missbigscore2aig_7@driver", "boot_l_loop", 3.0, 3.0, -1, 48, 0, 0, 0, 0)
    Wait(700)
    TriggerEvent('animations:client:EmoteCommandStart', {"c"})
    loadAnimDict("anim@heists@load_box")
    Wait(100)
    TaskPlayAnim(ped, "anim@heists@box_carry@", "idle", 3.0, 3.0, -1, 48, 0, 0, 0, 0)
    Wait(800)
