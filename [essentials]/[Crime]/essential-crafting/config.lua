...
Config.Models = {
    base = {`apa_mp_apa_yacht_launcher_01a`},
}
...
Config.craftingBenches = {
    ...
    {id = "pbbase2", coords = vector3(-36.697395324707, -2689.7731933594, 6.0002355575562), heading = 358.47, objExists = false, prop = 'gr_prop_gr_bench_04b', benchType = 'base'},
