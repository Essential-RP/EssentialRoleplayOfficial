    ...
    window.addEventListener('message', function (event) {
        ...
        if (data.action == "ui") {
            ...
            if (data.toggle) {
                ...
                $.post('https://essential-characterselect/setupCharacters');
                // setTimeout(function(){
                    setTimeout(function(){
                        ...
                        $.post('https://essential-characterselect/removeBlur');
                    }, 4000);
                // }, 2000);
            } else {
...
$('.disconnect-btn').click(function(e){
    ...
    $.post('https://essential-characterselect/closeUI');
    $.post('https://essential-characterselect/disconnectButton');
});
...
$(document).on('click', '#CreateCharExpert', function (e) {
    ...
    if(AccessCreate){
        ...
        $.post('https://essential-characterselect/expertSendAlert', JSON.stringify({
...
$(document).on('click', '.RegisterGreen', function (e) {
    ...
    if(success){
        $.post('https://essential-characterselect/createNewCharacter', JSON.stringify({
            firstname: firstname,
            lastname: lastname,
...
$(document).on('click', '#accept-delete', function(e){
    $.post('https://essential-characterselect/removeCharacter', JSON.stringify({
...
$(document).on('click', '.SelectChar-SpawnChar', function(e) {
    ...
    if (selectedChar !== null) {
        $.post('https://essential-characterselect/selectCharacter', JSON.stringify({
