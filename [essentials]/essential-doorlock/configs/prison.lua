...
Config.DoorList['prison-frontoffice'] = {
    authorizedJobs = { ['rangers'] = 0, ['police'] = 0, ['bcso'] = 0, ['corrections'] = 0,['sast'] = 0 },
    doorRate = 1.0,
    doorType = 'door',
    locked = true,
    objYaw = 0.0,
...
-- pool-room created by Pug
Config.DoorList['prison-pool-room'] = {
    doorRate = 1.0,
    locked = false,
    distance = 1,
    authorizedJobs = { ['rangers'] = 0, ['police'] = 0, ['bcso'] = 0, ['corrections'] = 0,['sast'] = 0 },
    ...
    doorType = 'door',
    fixText = false,
    objYaw = 119.99996948242,
    objCoords = vec3(1752.280762, 2479.247559, 45.889881),
}

-- main-cells-inner created by Pug
Config.DoorList['prison-main-cells-inner'] = {
    doorRate = 1.0,
    locked = false,
    distance = 1,
    authorizedJobs = { ['rangers'] = 0, ['police'] = 0, ['bcso'] = 0, ['corrections'] = 0,['sast'] = 0 },
...
-- main-cells-outer created by Pug
Config.DoorList['prison-main-cells-outer'] = {
    doorRate = 1.0,
    locked = false,
    distance = 1,
    authorizedJobs = { ['rangers'] = 0, ['police'] = 0, ['bcso'] = 0, ['corrections'] = 0,['sast'] = 0 },
...
-- staff-only1 created by Pug
Config.DoorList['prison-config-staff-only1'] = {
    fixText = false,
    distance = 1,
    doorType = 'door',
    objYaw = 0.0,
...
-- staff-only2 created by Pug
Config.DoorList['prison-config-staff-only2'] = {
    fixText = false,
    distance = 1,
    doorType = 'door',
    objYaw = 0.0,
...
-- cell15 created by THX1139
Config.DoorList['prison-cell15'] = {
...
-- cell16 created by THX1139
Config.DoorList['prison-cell16'] = {
...
-- cell20 created by THX1139
Config.DoorList['prison-cell20'] = {
...
-- cell5 created by THX1139
Config.DoorList['prison-cell5'] = {
    doorLabel = 'cell5',
    doorRate = 1.0,
    distance = 2,
...
-- cell4 created by THX1139
Config.DoorList['prison-cell4'] = {
    doorLabel = 'cell4',
    doorRate = 1.0,
    distance = 2,
...
-- cell2 created by THX1139
Config.DoorList['prison-cell2'] = {
    doorLabel = 'cell2',
    doorRate = 1.0,
    distance = 2,
