...
-- Config.Deliver = {min = 8, max = 12} -- How many garbage bags per location?
...
Config.GroupPayLimit = 4 -- Change the group pay limit to 4 people to ensure all group members get the bonus

Config.Buffs = false -- Do you use ps or tnj buffs then enable this
Config.BuffExport = "tnj-buffs" -- Some people still use tnj-buffs some uses ps-buffs they are the just edit the BuffExport to whatever you use
