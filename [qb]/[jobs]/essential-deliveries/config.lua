...
Config.DeliveryMidReputation = 10
Config.DeliveryHighReputation = 10
...
Config.Shops = {
    [1] = { -- Do not add a 4th table unless you know what you are doing, its not as simple as just copy and pasting in here
        ...
        Payment = math.random(500, 600), --If you want a random payments then replace the number with a math.random(350, 420)
