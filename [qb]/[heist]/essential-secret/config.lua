...
Config.EmailTime = 45 --how many seconds after accepting job before you ge the email for it

--====Hack stuff====--

Config.HackItem = {'hackerusb , '} -- item used to hack things you are free to change it to whatever you want
Config.LabHackType = 'alphabet' -- can be alphabet, numeric, alphanumeric, greek, braille, runes
Config.LabHackTime = 10 --how long to do minigame
...
Config.LabBossModel2 = 'a_m_m_business_01'
Config.LabBossLocation = vector4(-77.261116027832, 369.76547241211, 112.45823669434, 116.94641113281)
Config.LabBossLocation2 = vector4(152.67805480957, -2199.1169433594, 4.6880202293396, 181.77795410156) -- change it you like
