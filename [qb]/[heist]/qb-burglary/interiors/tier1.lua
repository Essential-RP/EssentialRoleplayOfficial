...
Config.T1_Interiors = {
    ...
    [1] = {
        ...
        ["locations"] = {
            ...
            [13] = {
                ["name"] = { "tvshelf" }, -- [1] = Display name, QB item name is not required for search locations
                ["spawn"] = { vector3(256.49, -995.2, -99.01), },
                ["searched"] = false,
                ["chance"] = { math.random(100), 100 },
                ["poly"] = false,
                ["animation"] = "idle_e",
        ...
        ["key"] = {
            [1] = {
                ["name"] = { "Key", "t1_safe_key" },
                ["spawn"] = { 
                    vector3(263.19351196289, -1000.6311035156, -98.269309997559) 
