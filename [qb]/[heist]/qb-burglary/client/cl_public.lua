...
local function AlertCoppers(housePos)
    if not copsAlerted then
        ...
        exports["ps-dispatch"]:CustomAlert({
            coords = housePos,
            message = "Possible House Robbery in progress",
            dispatchCode = "10-90",
            description = "Possible House Robbery in progress, " .. gender .. " " .. "suspect",
            radius = 0,
            sprite = 40,
            color = 2,
            scale = 1.0,
...
function DisableSecurity(id, spawnId)
    ...
    elseif skillCheck == "voltlab" then
        TriggerEvent('ultra-voltlab', 45, function(result,reason)
