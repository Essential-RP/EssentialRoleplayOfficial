...
local function CallTruckRobberyPolice()
    local pos = GetEntityCoords(PlayerPedId())
    local DispatchData = {
        jobs = {["police"] = true, ["troopers"] = true, ["bcso"] = true, ["rangers"] = true},
        code = "10-90",
        callname = '[10-90] BANK TRUCK ROBBERY', -- The title of the alert.
        coords = pos,
        info = {{
            ...
            label = '[10-90] BANK TRUCK ROBBERY'
        }},
        blip = { 
            label = "10-90", 
            sprite = 477,
...
function ThermiteTruckSuccess()
    ...
    QBCore.Functions.Notify('Thermite Successful',"success")
    ThermiteEffect()
end
