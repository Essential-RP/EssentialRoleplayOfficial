...
Config.ConsumablesEat = {
    ...
    --catcafe
    ["bmochi"] = math.random(65, 80),
    ["pmochi"] = math.random(65, 80),
    ["gmochi"] = math.random(65, 80),
    ["omochi"] = math.random(65, 80),
    ["sake"] = math.random(65, 80),
    ["miso"] = math.random(65, 80),
    ["cake"] = math.random(65, 80),
    ["bento"] = math.random(65, 80),
    ["riceball"] = math.random(65, 80),
    ["nekocookie"] = math.random(65, 80),
    ["nekodonut"] = math.random(65, 80),
    ["cakepop"] = math.random(65, 80),
    ["pancake"] = math.random(65, 80),
    ["pizza"] = math.random(30, 45),
    ["purrito"] = math.random(65, 80),
    ["noodlebowl"] = math.random(65, 80),
    ["noodles"] = math.random(65, 80),
    ["ramen"] = math.random(65, 80),
    --Food 
    ...
    ["catcafe-buddhabowl"] = math.random(65, 75),
    ["catcafe-savorypancake"] = math.random(65, 75),
    ["catcafe-cicecreamsandy"] = math.random(65, 75),
    ["catcafe-vicecreamsandy"] = math.random(65, 75),
    ["catcafe-donut"] = math.random(65, 75),
    ["catcafe-cupcake"] = math.random(65, 75),
    ["catcafe-sushi"] = math.random(65, 75),
    ["catcafe-misosoup"] = math.random(65, 75),
...
Config.ConsumablesDrink = {
    ...
    ["bean-cafe"] = math.random(40, 50),
    ["bobatea"] = math.random(60, 80),
    ["bbobatea"] = math.random(60, 80),
    ["gbobatea"] = math.random(60, 80),
    ["pbobatea"] = math.random(60, 80),
    ["obobatea"] = math.random(60, 80),
    ["nekolatte"] = math.random(60, 80),
    ["catcoffee"] = math.random(60, 80),
    -- ["miso"] = math.random(35, 45),
    ["mocha"] = math.random(60, 80),
}
