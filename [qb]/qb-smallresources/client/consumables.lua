...
function HealOxy()
    ...
    while count > 0 do
        Wait(1000)
        exports["ps-buffs"]:AddBuff("super-health", 1200)
        count = count - 1
...
-- RegisterNetEvent('consumables:client:gauze', function()
--     QBCore.Functions.Progressbar("use_gauze", Lang:t('consumables.healing_progress'), 4000, false, true, {
--         disableMovement = false,
--         disableCarMovement = false,
--         disableMouse = false,
--         disableCombat = true,
...
--         TriggerServerEvent("consumables:server:useGauze")
