const Targeting = Vue.createApp({
    data() {
        return {
            ...
            StandardEyeIcon: 'https://cdn.discordapp.com/attachments/1016664389857837166/1144755959055536148/New_Project_6.png', // Instead of icon it's using a image source found in HTML 
            CurrentIcon: 'https://cdn.discordapp.com/attachments/1016664389857837166/1144755959055536148/New_Project_6.png', // Instead of icon it's using a image source found in HTML
            SuccessIcon: 'https://cdn.discordapp.com/attachments/1016664389857837166/1144743136288063619/New_Project_4.png', // Instead of icon it's using a image source found in HTML
