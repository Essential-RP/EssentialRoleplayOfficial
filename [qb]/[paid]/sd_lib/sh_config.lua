...
Config.Dispatch = '' -- ps-dispatch/linden_outlawalert/cd_dispatch/core_dispatch/qs-dispatch/custom (In client/cl_utils.lua, you can add your own dispatch system into the 'custom' field)
