...
server_scripts { 'sv_config.lua', 'server/sv_framework.lua', 'shared/logs.lua',  'server/version.lua', } 
...
escrow_ignore { 'client/*.lua', 'server/*.lua', 'shared/*.lua', 'sh_config.lua', 'sv_config.lua', 'client/menu/**/*.*', }
