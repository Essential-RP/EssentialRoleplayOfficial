...
local props = {
	...
	-- ["duffle2"] = { model = "prop_michael_backpack", hash = joaat("prop_michael_backpack"), tier = 1 },
	...
	["musicequipment"] = { carry = true, model = "prop_speaker_06", bone = 24817, x = 0.00, y = 0.43, z = 0.05, xr = 91.0,
		yr = 0.0, zr = -265.0, blockAttack = true, blockCar = true, blockRun = true },
	["package"]      = { carry = true, model = "hei_prop_heist_box", bone = 24817, x = -0.20, y = 0.43, z = 0.05, xr = 91.0,
		yr = 0.0, zr = -265.0, blockAttack = true, blockCar = true, blockRun = true },
