...
let new_degrees = 0;
let time = 0;
let color = "#899499";    // needle and winning line if fail             
let txtcolor = "rgb(0, 150, 255)"; // number
let bgcolor = "rgb(128, 128, 128)"; // main circle color
let bgcolor2 = "rgb(0, 150, 255)"; // Winning line
let bgcolor3 = "#00ff00";
let key_to_press;
let g_start, g_end;
let animation_loop;
